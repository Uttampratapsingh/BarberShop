...
export default function BridalJourneyCTA() {
  ...
  return (
    <section className="relative min-h-[595px] overflow-hidden bg-[#080808] px-5 sm:px-8">
      {/* Background */}
      ...
      <div className="relative z-10 mx-auto flex min-h-[595px] max-w-[1500px] flex-col items-center justify-center text-center">
        ...
        <a
          ...
          className="
            ...
            tracking-[-0.02em]
            text-black
            shadow-[0_10px_35px_rgba(217,176,54,0.08)]
            transition-all
            duration-500
            hover:-translate-y-2
            hover:scale-[1.02]
            hover:bg-[#e5bd45]
            hover:shadow-[0_18px_45px_rgba(217,176,54,0.2)]
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-px bg-[#5b450d]/30" />
